...
const fs = require('fs'); //NO RECUERDO MUY BIEN QUE HACE
const path = require('path'); //NO RECUERDO MUY BIEN QUE HACE
const {
...
sequelize.models = Object.fromEntries(capsEntries); //NO SE ESTO QUE HACE
